...
void tensor_z() {
    ...
    std::vector<dd::Index> indexs = { {"x1",2},{"x1",2}};

    dd::Tensor tn = { U,indexs, "z" };
    dd::TDD tdd = tn.to_tdd(dd1);
    std::cout << tdd.e.p->v << std::endl;
    dd::export2Dot(tdd.e, "cnot_z");
}
...
int main(int argc, char *argv[]) {
    std::cout << "cx _2" << std::endl;
    tensor_2_tdd_cx_2();
    std::cout << "cx _4" << std::endl;
    tensor_2_tdd_cx_4();
    std::cout << "hyber" << std::endl;
    tensor_hyper_index();

    std::cout << "z gate" << std::endl;
    tensor_z();
    return 0;
}